...
public enum ExceptionEnum {
    ...
    DEPOSIT_CHARGE_CONFIRM_EXCEPTION(HttpStatus.INTERNAL_SERVER_ERROR, "P0003", "예치금 충전 확인과정에서 문제가 발생했습니다."),

    MEMBER_NOT_REFUNDABLE_EXCEPTION(HttpStatus.BAD_REQUEST, "P0004", "환불 대상이 아닙니다."),
